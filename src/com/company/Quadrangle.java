...
public class Quadrangle {
    ...
    public String toString() {
        return ("The fist side of triangle: " + (findFirstSide()) + "; the second side: " + (findSecondSide()) +
                "; the third side: " + (findThirdSide())  + "; the perimeter: " +
                (findPerimeter()) + "; the area: " + (findArea())  + "\n");
    }
}