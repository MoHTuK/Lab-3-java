    ...
    public static void main(String[] args) throws IOException {
        ...
        switch (choseInput) {
            case "Y":
                ...
                quadrangleList.save("qwe123.txt");
                parallelogramList.save("qwq455.txt");
                break;
            case "N":
                String filePath = "E:\\Users\\Ветрогон Олександр\\IdeaProjects\\untitled1";
                ...
                if (reserveFiles != null && reserveFiles.length > 0) {
                    ...
                    if (Integer.parseInt(chosenBackup) < reserveFiles.length && Integer.parseInt(chosenBackup) >= 0) {
                        quadrangleList.load(reserveFiles[Integer.parseInt(chosenBackup)]);
